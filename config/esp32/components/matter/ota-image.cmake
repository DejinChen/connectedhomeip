...
function(chip_ota_image TARGET_NAME)
    ...
    file(GENERATE
        OUTPUT ${BUILD_DIR}/esp-args-ota-image.tmp
        CONTENT ${OTA_ARGS}
    )

    add_custom_target(${TARGET_NAME} ALL
        COMMAND ${Python3_EXECUTABLE} ${CMAKE_CURRENT_SOURCE_DIR}/../../../../src/app/ota_image_tool.py create @${BUILD_DIR}/esp-args-ota-image.tmp
    )
endfunction()
